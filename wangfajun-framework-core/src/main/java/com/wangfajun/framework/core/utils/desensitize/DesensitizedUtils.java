package com.wangfajun.framework.core.utils.desensitize;
...
public class DesensitizedUtils {
	...
	/**
	 * 【身份证号】显示前三位, 四位，其他隐藏。共计18位或者15位，比如：340304*******1234
	 *
	 * @param id 身份证号码
	 * @return 结果
	 */
	public static String idCardNum(String id) {
		return desValue(id, 3, 4, "*");
	}
	...
	/**
	 * 【银行卡号】前三位，后四位，其他用星号隐藏每位1个星号，比如：622260**********1234
	 *
	 * @param cardNum 银行卡号
	 * @return 结果
	 */
	public static String bankCard(String cardNum) {
		return desValue(cardNum, 3, 4, "*");
	}
